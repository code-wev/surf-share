...
export function LoginForm() {
  return (
    <form className="mt-12 space-y-5 [font-family:var(--font-sf-pro)]" noValidate>
      ...
      <div className="flex items-center justify-between pt-12">
        <p className="text-sm text-text-weak">
          ...
          <Link href="#" className="font-medium text-brand-default hover:underline">
            Sign Up
          </Link>
        </p>
        <button
          type="submit"
          className="inline-flex items-center gap-2 rounded-md bg-brand-default px-4 py-2 text-sm font-medium text-text-inverse-strong transition-colors hover:bg-brand-hover"
        >
          Login
          <ArrowRight size={18} />
        </button>
