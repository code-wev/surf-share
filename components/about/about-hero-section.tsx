export default function AboutHeroSection() {
  return (
    <section className="bg-brand-disabled">
      <div className="px-4 py-14 text-center sm:px-6 sm:py-16 md:px-10 md:py-20 lg:px-12.5 lg:py-22 2xl:py-25">
        ...
        <p className="mx-auto mt-3 max-w-360 text-sm leading-6 text-text-weak sm:mt-4 sm:text-base sm:leading-7 lg:mt-6 lg:text-[28px] lg:leading-tight">
          Connecting surf photographers with riders to capture and share the stoke
        </p>
      </div>
    </section>
  );
